...
echo ""
echo "3. Test flame sensor (new feature):"
echo "   python scripts/test-flame-sensor.py"
echo ""
echo "4. Run the IoT client:"
echo "   cd ~/raspberry-pi/src"
echo "   python iot_client.py"
echo ""
echo "   Or in mock mode (no hardware):"
echo "   MOCK_MODE=true python iot_client.py"
echo ""
echo "Or test other hardware:"
echo "   python scripts/test-hardware.py"
echo ""
